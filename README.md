...
📦 [`krates`](https://github.com/EmbarkStudios/krates) | `krates` Creates graphs of crates from cargo metadata | [![Latest version](https://img.shields.io/crates/v/krates.svg)](https://crates.io/crates/krates)
